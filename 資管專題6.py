...
# 設置郵件服務
app.config['MAIL_SERVER'] = 'smtp.example.com'  # 替換為您的郵件伺服器
app.config['MAIL_PORT'] = 587
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_USERNAME'] = 's92080276@gmail.com'  # 替換為您的郵件帳號
app.config['MAIL_PASSWORD'] = 'hrvz otsy tbbr rbmf'  # 替換為您的郵件密碼
